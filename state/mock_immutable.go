...
// Source: github.com/sausaging/hypersdk/state (interfaces: Immutable)
//
// Generated by this command:
//
//	mockgen -package=state -destination=state/mock_immutable.go github.com/sausaging/hypersdk/state Immutable
//
