...
// Source: github.com/sausaging/hypersdk/state (interfaces: Mutable)
//
// Generated by this command:
//
//	mockgen -package=state -destination=state/mock_mutable.go github.com/sausaging/hypersdk/state Mutable
//
