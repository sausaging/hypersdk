...
// go test -v -timeout 30s -run ^TestTokenProgram$ github.com/sausaging/hypersdk/x/programs/examples -memprofile benchvset.mem -cpuprofile benchvset.cpu
...
// go test -v -benchmem -run=^$ -bench ^BenchmarkTokenProgram$ github.com/sausaging/hypersdk/x/programs/examples -memprofile benchvset.mem -cpuprofile benchvset.cpu
