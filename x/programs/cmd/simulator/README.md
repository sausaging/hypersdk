...
And please, if you see any inconsistencies in the `README.md`` here, [open a PR](https://github.com/sausaging/hypersdk/edit/main/x/programs/cmd/simulator/README.md)!
